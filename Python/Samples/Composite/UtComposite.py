...
class UtComposite(unittest.TestCase):
    ...
    def test_organization(self):
        newProdDev = NewProdDev(title="產品管理部", head="達斯西帝斯")
        mobileProd = MobileProd(title="行動裝置部", head="達斯維達")
        appDev = AppDev(title="APP開發課", head="弒星者")
        newBsDev = NewBsDev(title="新商機開發課", head="白兵隊長")
